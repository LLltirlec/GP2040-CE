...
// Android generic HID: same report bytes as ps4_report_descriptor, but axis usages match
// the common mapping (right stick = Rx/Ry, L2/R2 = Z/Rz). Sony/PS4 uses the opposite labels.
static const uint8_t ps4_report_descriptor_android[] =
{
	0x05, 0x01,        // Usage Page (Generic Desktop Ctrls)
	0x09, 0x05,        // Usage (Game Pad)
	0xA1, 0x01,        // Collection (Application)
	...
	0x09, 0x30,        //   Usage (X)
	0x09, 0x31,        //   Usage (Y)
	0x09, 0x33,        //   Usage (Rx) // ANDROID: was Z
	0x09, 0x34,        //   Usage (Ry) // ANDROID: was Rz
	0x15, 0x00,        //   Logical Minimum (0)
	0x26, 0xFF, 0x00,  //   Logical Maximum (255)
	0x75, 0x08,        //   Report Size (8)
	0x95, 0x04,        //   Report Count (4)
	...
	0x05, 0x01,        //   Usage Page (Generic Desktop Ctrls)
	0x09, 0x32,        //   Usage (Z) // ANDROID: was Rx (L2 analog)
	0x09, 0x35,        //   Usage (Rz) // ANDROID: was Ry (R2 analog)
	0x15, 0x00,        //   Logical Minimum (0)
	0x26, 0xFF, 0x00,  //   Logical Maximum (255)
	0x75, 0x08,        //   Report Size (8)
	0x95, 0x02,        //   Report Count (2)
