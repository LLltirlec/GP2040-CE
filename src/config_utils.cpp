...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(config.gamepadOptions, ps4HidAndroidAxisCompat, false);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.keyboardHostOptions, mouseReportLayout, MOUSE_LAYOUT_STANDARD);
