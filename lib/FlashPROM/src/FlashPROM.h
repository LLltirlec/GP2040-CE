...
#define EEPROM_SIZE_BYTES    0x9000           // Reserve 36k of flash memory for config (fits PS4 keys; ensure divisible by 256)
#define EEPROM_ADDRESS_START _u(0x101F7000)  // Start 4KB earlier so config + footer fits in 36KB
